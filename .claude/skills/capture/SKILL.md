...
The operator types `/capture` after sustained work, or as a session wrap-up.
...
7. **Generate nav**: `bash scripts/generate-nav.sh`
8. **Validate**: `bash scripts/validate-consistency.sh`
