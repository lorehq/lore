...
All user-invocable skills MUST be named `lore-<action>` (e.g., `/lore-capture`, `/lore-docker`). Non-user-invocable fieldnotes (internal snag captures) don't need the prefix.
