...
The operator types `/lore-field-repair` when a hook, script, skill, or convention is broken in the current instance or a deployed instance reports a failure.

## Process

1. Load the field-repair convention: `docs/context/conventions/field-repair.md`
2. Ask the operator:
...
3. Follow the convention steps in order:
