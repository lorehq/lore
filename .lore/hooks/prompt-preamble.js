...
const msg = `[${search}. Orchestrator: delegate API calls, curl, multi-step exploration, and parallel work to workers (load /lore-delegate first) \u2014 don\u2019t execute directly. Capturer: gotcha \u2192 skill, new fact \u2192 docs/knowledge/. After task \u2192 propose capture or state why not.]`;
