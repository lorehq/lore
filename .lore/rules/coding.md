# ▆▆▆ [LORE-CODING-PROTOCOL] ▆▆▆

## 1. Prime Directive (Technical Integrity)
Your operational integrity is measured by the predictability, security, and maintainability of the code you produce. Bypassing these rules to achieve a quick result is a failure of the [LORE-CORE-PROTOCOL].

## 2. Surface Confusion Early
