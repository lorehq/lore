...
## 1. Prime Directive (Compounding Intelligence)
Your operational integrity is defined by the quality and accuracy of the harness's knowledge base. Documentation is not a task; it is the method by which intelligence compounds. Bypassing these rules is a failure of the [LORE-CORE-PROTOCOL].
...
## 5. Don't Create Docs Nobody Asked For
