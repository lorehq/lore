...
[93m▆▆▆ [LORE-HARNESS-PROTOCOL] ▆▆▆[0m
VERSION:  v0.15.0
SEMANTIC SEARCH: http://localhost:9185/search
KNOWLEDGE BASE: /home/andrew/.lore/knowledge-base

[92m▆ HOT MEMORY: active[0m — capture context (lore_hot_session_note), recall before research (lore_hot_recall).

FIELDNOTES: bash-heredoc-json-injection, bash-macos-compat, bash-set-e-return-guard, bw-create-item, c8-subprocess-coverage-blind-spot, ceph-vlan-arp-conflict, ci-lint-scans-checkout-dirs, claude-cli-no-root-skip-perms, claude-code-pretooluse-output-format, claude-global-hooks-conflict, cursor-hook-output-limits, eslint-10-node-18-crash, fastembed-local-files-only, gh-multi-account, git-crlf-shell-scripts, git-mv-gitignored-files, github-pages-frontmatter-required, gitignored-nav-drift, lore-docker-update-volume-conflict, lxc-container-gotchas, lxc-gpu-passthrough, mcp-stdio-content-length-framing, mkdocs-panzoom-serve-assets, node-macos-stdin-fd, opencode-session-created-not-a-hook, pbs-backup-troubleshooting, platform-command-collisions, proxmox-bridge-rename, pymdownx-extension-order, safe-edit-special-chars, unicode-escape-edit-mismatch

AVAILABLE RUNBOOKS: ansible-docker-role, bidirectional-code-docs-sync, ceph-operations, code-tidy-sweep, cross-platform-vm-test, docs-code-alignment-sweep, docs-site-restructure, k3s-operations, opnsense-api, orders-inventory-field-test, runbooks-overview, session-token-usage-from-claude-logs, terraform-operations, testing-opencode-plugins, vaultwarden-bw-cli, vaultwarden-env-vars
