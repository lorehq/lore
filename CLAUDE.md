...
AVAILABLE RUNBOOKS: ansible-docker-role, bidirectional-code-docs-sync, ceph-operations, code-tidy-sweep, docs-code-alignment-sweep, docs-site-restructure, k3s-operations, opnsense-api, orders-inventory-field-test, runbooks-overview, session-token-usage-from-claude-logs, terraform-operations, testing-opencode-plugins, vaultwarden-bw-cli, vaultwarden-env-vars
