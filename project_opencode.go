...
// Generated by lore project — do not edit manually.
  ...
  hooks: {
    "tool.execute.before": (ctx) => {
      try {
        ...
        execSync("lore hook pre-tool-use", { input, stdio: ["pipe", "pipe", "inherit"] });
      } catch (_) {}
    },
    ...
    "tool.execute.after": (ctx) => {
      try {
        const input = JSON.stringify(ctx);
        execSync("lore hook post-tool-use", { input, stdio: ["pipe", "pipe", "inherit"] });
      } catch (_) {}
    },
  },
};
