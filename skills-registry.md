...
|-------|--------|-------------|
| lore-capture | Orchestrator | Session-scoped knowledge capture — review work, create skills, update registries |
| lore-consolidate | Orchestrator | Deep repo-wide health check — stale items, overlap, duplication |
| lore-create-agent | Orchestrator | Create a domain agent when a skill has a clear domain |
| lore-create-brainstorm | Orchestrator | Create a brainstorm folder — always standalone, never nested |
...
| lore-link | Orchestrator | Link and unlink work repos to the Lore hub |
